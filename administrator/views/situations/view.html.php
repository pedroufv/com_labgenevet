 ...
 * @since  1.6
 */
class LabgenevetViewSituations extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		// Load the submenu.
		LabgenevetHelper::addSubmenu('situations');
	...
	protected function addToolbar()
	{
        ...
        JToolBarHelper::title(JText::_('COM_LABGENEVET_SITUATIONS'), 'tags');
        ...
        JHtmlSidebar::setAction('index.php?option=com_labgenevet&view=situations');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_LABGENEVET_SITUATION'),
