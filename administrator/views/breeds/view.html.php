 ...
 * @since  1.6
 */
class LabgenevetViewBreeds extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		// Load the submenu.
		LabgenevetHelper::addSubmenu('breeds');
	...
	protected function addToolbar()
	{
        ...
        JToolBarHelper::title(JText::_('COM_LABGENEVET_BREEDS'), 'tags');
        ...
        JHtmlSidebar::setAction('index.php?option=com_labgenevet&view=breeds');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_LABGENEVET_BREED'),
			'a.`description`' => JText::_('COM_LABGENEVET_DESCRIPTION'),
			'a.`speciesid`' => JText::_('COM_LABGENEVET_SPECIE'),
